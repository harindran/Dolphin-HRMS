        ...
        Private Sub Calculation_shifttime()
            Try
                ...
                If ochkexclude.Checked = True Then
                    ...
                    Dim shift_mins As Integer = arr(0) * 60 + arr(1) 'Int(objform.Items.Item("txtstotal").Specific.string) * 60 + (objform.Items.Item("txtstotal").Specific.string - Int(objform.Items.Item("txtstotal").Specific.string))
            ...
            Try
                ...
                If objform.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or objform.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE Then
                    ...
                    If Val(objform.Items.Item("txtstotal").Specific.String) <= 0 Then
                        ...
                        BubbleEvent = False : Exit Sub
                    End If
                    If Val(objform.Items.Item("txtltotal").Specific.String) <= 0 Then
