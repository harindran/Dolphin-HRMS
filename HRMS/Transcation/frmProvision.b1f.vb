...
Namespace HRMS
    ...
    Friend Class frmProvision
        ...
        Private Sub OnCustomInitialize()
            ...
            Try
                strsql = "select Distinct Datepart(YYYY,ProvisionDate),Datepart(YYYY,ProvisionDate)  from HRMS_PROVISION_DETAILS"
...
#End Region
        ...
        Private Sub Button0_ClickAfter(sboObject As System.Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles Button0.ClickAfter
            Try
                ...
                strsql = "[Innova_HRMS_Provision_Report] '" & ComboBox0.Selected.Value.ToString & "','" & ComboBox1.Selected.Value.ToString & "'"
        ...
        Private Sub Button1_ClickAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles Button1.ClickAfter
            If objaddon.objapplication.MessageBox("Do you want to finalize and post the Journal vouchers?", 2, "Yes", "No") = 1 Then
                Try
                    strsql = "Update HRMS_PROVISION_DETAILS set Finalize='Y' where Datepart(MM,provisiondate)='" & ComboBox0.Selected.Value.ToString & "' and Datepart(YYYY,provisiondate)='" & ComboBox1.Selected.Value.ToString & "'"
