...
Namespace HRMS
    ...
    Friend Class frmAirTicketIssue
        ...
        Public Overrides Sub OnInitializeFormEvents()
            AddHandler DataLoadAfter, AddressOf Me.frmAirTicketIssue_DataLoadAfter
        End Sub
...
#End Region
        ...
        Private Sub EditText0_ChooseFromListAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles EditText0.ChooseFromListAfter
            Try
                ...
                Load_Emp_Details()
            Catch ex As Exception
                objaddon.objapplication.SetStatusBarMessage("Error in Choose From List Selection : " & ex.ToString, SAPbouiCOM.BoMessageTime.bmt_Medium, True)
            End Try
        End Sub
        ...
        Private Sub Load_Emp_Details()
            Try
                ...
                Dim objrs As SAPbobsCOM.Recordset
                strsql = " EXEC [Innova_HR_GetEmpDetails_AirticketIssue] '" & EditText0.Value & "','" & EditText7.Value & "'"
        ...
        Private Sub LinkedButton0_ClickAfter(sboObject As System.Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles LinkedButton0.ClickAfter
            ...
            Link_Value = EditText0.Value : Link_objtype = "OHEM"
        ...
        Private Sub ComboBox0_ComboSelectAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles ComboBox0.ComboSelectAfter
            ...
            EditText13.Value = objaddon.objglobalmethods.GetDocnum_BaseonSeries("OTIS", ComboBox0.Selected.Value)
        End Sub
        ...
        Private Sub EditText14_LostFocusAfter(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles EditText14.LostFocusAfter
            Try
                objaddon.objglobalmethods.LoadCombo_Series(objform, "cmbseries", "OTIS", IIf(EditText14.String = "", Now.Date, Date.ParseExact(EditText14.String, "dd.MM.yyyy", System.Globalization.DateTimeFormatInfo.InvariantInfo)))
            Catch ex As Exception
