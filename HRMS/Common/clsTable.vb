...
#Region "Master Data Creation"
        ...
        Private Sub EmployeeMasterdata()
            ...
            AddFields("@SMPR_OHEM", "grade", "Grade", SAPbobsCOM.BoFieldTypes.db_Alpha, 10)
            ...
            '-----------Bank Details
            AddFields("@SMPR_OHEM", "paymode", "Pay Mode", SAPbobsCOM.BoFieldTypes.db_Alpha, 100, , , , , {"00,", "CA,Cash", "CH,Cheque", "C3,C3 Card - Non WPS", "NW,NON-WPS", "WP,WPS", "C3Card-WPS,C3 Card - WPS"})
...
#Region "Document Data Creation"
        ...
        Private Sub DailyAttendance()
            ...
            AddFields("@SMPR_DAS1", "HalfStatus", "Half Day Attd Status", SAPbobsCOM.BoFieldTypes.db_Alpha, 5)
            ...
            AddFields("@SMPR_DAS1", "TimeIn", "Time In", SAPbobsCOM.BoFieldTypes.db_Float, , SAPbobsCOM.BoFldSubTypes.st_Time)
            AddFields("@SMPR_DAS1", "TimeOut", "Time Out", SAPbobsCOM.BoFieldTypes.db_Float, , SAPbobsCOM.BoFldSubTypes.st_Time)
        ...
        Private Sub Settlement()
            ...
            AddFields("@SMPR_OLSE", "Paid", "Paid", SAPbobsCOM.BoFieldTypes.db_Alpha, 10)
        ...
        Private Sub AddFields(ByVal strTab As String, ByVal strCol As String, ByVal strDesc As String, ByVal nType As SAPbobsCOM.BoFieldTypes, _
            ...
            Try
                ...
                If Not IsColumnExists(strTab, strCol) Then
                    ...
                    If val <> 0 Then
                        objaddon.objapplication.SetStatusBarMessage(objaddon.objcompany.GetLastErrorDescription, True)
                    End If
                    'System.Runtime.InteropServices.Marshal.ReleaseComObject(oUserFieldMD1)
                End If
            Catch ex As Exception
